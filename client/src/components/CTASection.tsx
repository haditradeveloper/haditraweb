      ...
      <div className="max-w-4xl mx-auto px-6 lg:px-16 text-center relative z-10">
        ...
        <div className="flex flex-wrap items-center justify-center gap-4">
          <Button
            ...
            className="bg-primary hover:bg-primary/90 text-primary-foreground px-6 py-3 text-sm font-medium rounded-none transition-colors duration-200"
          ...
          <Button
            ...
            className="border border-border text-foreground hover:border-primary px-6 py-3 text-sm font-medium rounded-none transition-colors duration-200"
            onClick={() => {
